...
tmux neww
tmux send-keys "export ROS_MASTER_URI=http://192.168.0.200:11311 ; export ROS_IP=192.168.150.100 ; source /opt/ros/noetic/setup.bash ; . /opt/ros/noetic/setup.bash ; rostopic pub Speed_Request_Speed std_msgs/Float32 8 $*" ENTER 
tmux neww
